...
import Linkedin from '/Users/arjunsudhalkar/Software/VSCode/Portfolio/react-portfolio/src/assets/linkedin-image.png'
...
return(
    <div  id = "contact" className = 'w-full py-16 '> 
        <div className = ' max-w-[1240px] max-auto grid lg:grid-cols-3' >
            ...
            <div className = 'my-4'>
                <div className='flex flex-col sm:flex-row items-center justify-betrween w-full'> 
